...
#         --model EEGPT \
#         --eval \
#         --finetune /home/aa2650/playground/EEGPT/checkpoint/eegpt_mcae_58chs_4s_large4E.ckpt \
#         --weight_decay 0.05 \
#         --batch_size 100\
#         --lr 5e-4 \
#         --update_freq 1 \
...
# CUDA_VISIBLE_DEVICES=0,1 OMP_NUM_THREADS=1 python -m torch.distributed.run --nproc_per_node=${GPUS_PER_NODE} \
#         --master_port ${MASTER_PORT} --nnodes=${N_NODES} --node_rank=0 --master_addr="localhost" \
#         run_class_finetuning_EEGPT_change.py \
#         --output_dir ./checkpoints/finetune_tuab_eegpt/ \
#         --log_dir ./log/finetune_tuab_eegpt \
